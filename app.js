...
async function requireOwner(next='partner-ops-dashboard.html'){
  ...
  if(error||data!==true){
    ...
    document.body.innerHTML='<main class="wrap pageMain"><section class="panel"><h1>Partner access only</h1><p>This private operations portal is restricted to approved RouteRefund partner emails.</p><a class="btn primary" href="partner-ops-login.html">Log in with partner email</a><a class="btn ghost" href="trips.html">Customer dashboard</a></section></main>';
    return null;
  }
  return user;
}
